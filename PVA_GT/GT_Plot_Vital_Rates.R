...
toplot <- ForecastVitalRates(params,thispar,scen,rep,1:94,thispixel,thisclim)

#  plot all relationships
temp <- sapply(setdiff(names(toplot),c("year")),function(t) plot(toplot$year,toplot[[t]],type="l",lwd=2,xlab="year",ylab=t,main=sprintf("pix %s, rep %s, scen %s",thispixel,rep,scen)) )
